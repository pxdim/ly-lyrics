...
func (e PlaylistEdges) PlaylistSongsOrErr() ([]*PlaylistSong, error) {
	if e.loadedTypes[1] {
...
// QueryPlaylistSongs queries the "playlist_songs" edge of the Playlist entity.
func (_m *Playlist) QueryPlaylistSongs() *PlaylistSongQuery {
	return NewPlaylistClient(_m.config).QueryPlaylistSongs(_m)
}
