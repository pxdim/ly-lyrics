...
func (_c *UserCreate) AddSongIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddSongIDs(ids...)
	return _c
}

// AddSongs adds the "songs" edges to the Song entity.
func (_c *UserCreate) AddSongs(v ...*Song) *UserCreate {
...
func (_c *UserCreate) SetSettingsID(id uuid.UUID) *UserCreate {
...
func (_c *UserCreate) SetNillableSettingsID(id *uuid.UUID) *UserCreate {
	if id != nil {
...
func (_c *UserCreate) SetSettings(v *Settings) *UserCreate {
